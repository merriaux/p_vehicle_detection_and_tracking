...
class ProcessImage:
    ...
    def debug_image2(self, img1, img2=None, img3=None, img4=None, img5=None, img6=None, img7=None, img8=None, img9=None, img10=None, img11=None):
        ...
        if img4 is not None:
            img4R = cv2.resize(img4, (320, 180), interpolation=cv2.INTER_CUBIC)
            if (len(img4R.shape) == 3):
                outImg[720:720 + 180, 0:320, :] = img4R
            else:
                outImg[720:720 + 180, 0:320, 0] = img4R * 255
                outImg[720:720 + 180, 0:320, 1] = img4R * 255
                outImg[720:720 + 180, 0:320, 2] = img4R * 255

        if img5 is not None:
            img5R = cv2.resize(img5, (320, 180), interpolation=cv2.INTER_CUBIC)
            if (len(img5R.shape) == 3):
                outImg[720:720 + 180, 0 + 320:320 + 320, :] = img5R
            else:
                outImg[720:720 + 180, 0 + 320:320 + 320, 0] = img5R * 255
                outImg[720:720 + 180, 0 + 320:320 + 320, 1] = img5R * 255
                outImg[720:720 + 180, 0 + 320:320 + 320, 2] = img5R * 255

        if img6 is not None:
            img6R = cv2.resize(img6, (320, 180), interpolation=cv2.INTER_CUBIC)
            if (len(img6R.shape) == 3):
                outImg[720:720 + 180, 0 + 320 + 320:320 + 320 + 320, :] = img6R
            else:
                outImg[720:720 + 180, 0 + 320 + 320:320 + 320 + 320, 0] = img6R * 255
                outImg[720:720 + 180, 0 + 320 + 320:320 + 320 + 320, 1] = img6R * 255
                outImg[720:720 + 180, 0 + 320 + 320:320 + 320 + 320, 2] = img6R * 255
    ...
    def computeWeightImg(self, winCarDetected, weightWinCarDetected, shape):
        ...
        for i in range(0, len(winCarDetected)):
            ...
            img[window[0][1]:window[1][1], window[0][0]:window[1][0], :] = img[window[0][1]:window[1][1],
                                                                           window[0][0]:window[1][0], :] + \
                                                                           weightWinCarDetected[i];
    ...
    def FullFrameMultiScaleProcess(self, rawImg):
        ...
        for scale in scales:
            ...
            imgResized = cv2.resize(img_lab, (int(img_lab.shape[1] / scale), int(img_lab.shape[0] / scale)),
    ...
    def testFullFrameProcess(self):
        ...
        imgBox = self.SlidWin.draw_boxesNP(image, windows[np.logical_and(yPred == 1, yBelief > 0.1)], color=(0, 255, 0),
                                           thick=2)
        plt.figure()
        plt.imshow(imgBox)
        plt.show()
